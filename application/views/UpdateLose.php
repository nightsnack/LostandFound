                ...
                <div class="box-body">
                 ...
                 <div class="form-group has-success">
                  ...
                  <form role="form" id="updateForm" action="" method="post">
                    ...
                    <div class="form-group">
                      <label>找回状态</label>
                      <select class="form-control" id="retrieve_id" name="retrieve_id">
...
<script>
    $().ready(function() {
        ...
        $("#retrieve_id").val("<?php echo $retrieve_id?>");
        $("#updateForm").validate({
            submitHandler: function() {
                $("#updateForm").ajaxSubmit({
                    type: "post",
                    url: "<?php echo site_url('Lose/updateItem')?>",
                    dataType: "json",
                    success: function(result) {
                        ...
                        {
                            alert("更新成功!");
                             window.location.href="<?php echo site_url('Lose/showDetail')."/".$item_id?>"; 
                        }
                        else
                            alert(result.error);
