...
<html>
  ...
  <body class="hold-transition skin-red-light sidebar-mini">
      ...
      <header class="main-header">
        ...
        <!-- Logo -->
        <a href="<?php echo site_url('Management/Main')?>" class="logo">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-footer">
                    ...
                    <div class="pull-right">
                      <a href="<?php echo site_url('Management/User/logout')?>" class="btn btn-default btn-flat">退出</a>
                    </div>
                  </li>
                </ul>
              </li>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li><a href="#"><i class="fa fa-link"></i> <span>Another Link</span><i class="fa fa-angle-left pull-right"></i></a>
